  ...
  <div class="dashboard">
    ...
    <div class="widgets">
      ...
      <div class="ga-widget ga-widget-last widget half">
        <google-analytics-doughnut-chart title="{{ $top_referrers }}" endpoint="top-referrers" label-position="right" date-picker="hide"></google-analytics-horizontal-bar-chart>
      </div>

      <div class="ga-widget ga-widget-last widget half">
        <google-analytics-doughnut-chart title="{{ $top_browsers }}" endpoint="top-browsers" label-position="right" date-picker="hide"></google-analytics-horizontal-bar-chart>
      </div>
    </div>
  </div>
@stop
